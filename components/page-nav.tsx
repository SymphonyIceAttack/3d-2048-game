...
export default function PageNav({ borderColor = "purple" }: PageNavProps) {
  ...
  return (
    <nav
      className={`sticky top-0 z-50 border-b-2 ${borderClass} bg-white/95 dark:bg-slate-900/95 backdrop-blur-md`}
    >
      <div className="container mx-auto px-4 py-3 md:py-4 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-3 group">
          ...
          <span
            className={`text-xl md:text-2xl font-black tracking-tight text-gray-900 dark:text-white uppercase ${hoverClass} transition-colors`}
          >
            3D 2048
          </span>
        </Link>
